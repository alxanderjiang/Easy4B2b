...
The virtual serial port tool can be downloaded from the [[**Virtual Serial Port Driver**]](VSPD) website [[]](https://www.virtual-serial-port.org/user-guides/standard/installation.html).
